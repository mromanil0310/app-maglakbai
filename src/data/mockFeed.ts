// MaglakbAI community feed SEED/PREVIEW data (not live) — extracted from appStore.ts (ARCH-002).
...
export const MOCK_FEED: FeedPost[] = [
  ...
  // ── Career Win seed posts — social proof of MaglakbAI outcomes ──────────
  {
    id: 'fp-win-001',
    userId: 'kenji_ml_sf',
    userName: 'Kenji Nakamura',
  ...
  },
  {
    ...
    content: '🚀 Got promoted: Promoted to Senior Frontend Engineer at Shopify. 6 months of consistent logging on MaglakbAI. My manager literally cited my React architecture project as the reason I was ready for the promotion. Keep building in public.',
    xpGained: 400,
